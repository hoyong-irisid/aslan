...
def _partner_html(filename: str) -> HTMLResponse:
    ...
    for nav_path in (_PARTNER_ADMIN_PATH, _PARTNER_REGISTER_PATH, _PARTNER_SETTINGS_PATH, _PARTNER_LOG_PATH):
...
if _PARTNER_DIR.is_dir():
    ...
    @app.get(_PARTNER_LOG_PATH, include_in_schema=False)
    def partner_log_page() -> HTMLResponse:
        return _partner_html("log.html")
